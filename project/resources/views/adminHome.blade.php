...
<html>
    <head>
        <title>E-Books</title>
        <link rel="stylesheet" type="text/css" href="<?php echo asset('css/adminHome.css')?>">
    </head>
    <body>
        <header>
        ...
        <section>
            ...
            @foreach($products as $product)
                <div class="product-card">
                    ...
                    <a href="{{ route('delete' , [$product->product_id])}}" class="btn">Delete Product</a>
                </div>
            @endforeach
        </section>
        <a href="{{ route('addPage') }}" class="add">Add Product</a>
